...
Engine::Engine() : m_window(WindowInit()), m_editor(this, m_window)
{
  ...
  Input::Init(m_window);
	...
	obj.AddComponent<RigidBodyComponent>(glm::vec3(0, 0, 0), glm::vec3(.000301, .000301, 0));
	obj.AddComponent<DynamicCollider2DComponent>(Collider2D::colliderType::colliderBox, glm::vec3(.1, .1, 0));
