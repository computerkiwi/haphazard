...
void Gamepad::UpdateAxes()
{
 ...
 //   gamepadAxisVals_[GamepadAxis::LeftAnalog_X] = axisValues_[GamepadAxis::LeftAnalog_X];
    std::cout << "Left analog X axis: " << axisValues_[static_cast<int>(GamepadAxis::LeftAnalog_X)] << std::endl;
  }
 ...
 //   gamepadAxisVals_[GamepadAxis::LeftAnalog_Y] = axisValues_[GamepadAxis::LeftAnalog_Y];
    std::cout << "Left analog Y axis: " << axisValues_[static_cast<int>(GamepadAxis::LeftAnalog_Y)] << std::endl;
  }
...
void Gamepad::UpdateButtons()
{
  ...
  // TODO: Figure out why buttons don't update on their own
  // I don't know why I have to keep calling this function for buttons to update
...
bool Gamepad::IsPressed(GamepadButton gamepadbutton)
{
  ...
  {
    //std::cout << "-- Function IsPressed() --" << std::endl;
    //std::cout << "Prev state: ";
    //BitPrint(buttonsPrevState_, numButtons_);
...
void Gamepad::EnableGamepad()
{
  ...
  if (axisValues_ == NULL)
  {
    std::cout << "Axis allocation failed" << std::endl;
  }
...
void Gamepad::GamepadDebug()
{
  ...
  ////// Buttons /////////////////////////////
  // 'A' Button
  if ((buttonsPrevState_[static_cast<int>(GamepadButton::A)] == KeyState::Released) &&
      (buttonsCurrState_[static_cast<int>(GamepadButton::A)] == KeyState::Pressed))
  {
    std::cout << "Button A is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::A)] == KeyState::HeldDown)
  {
    std::cout << "Button A is held down" << std::endl;
  }

  // 'B' Button
  if (buttonsCurrState_[static_cast<int>(GamepadButton::B)] == KeyState::Pressed)
  {
    std::cout << "Button B is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::B)] == KeyState::HeldDown)
  {
    std::cout << "Button B is held down" << std::endl;
  }

  // 'X' Button
  if (buttonsCurrState_[static_cast<int>(GamepadButton::X)] == KeyState::Pressed)
  {
    std::cout << "Button X is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::X)] == KeyState::HeldDown)
  {
    std::cout << "Button X is held down" << std::endl;
  }

  // 'Y' Button
  if (buttonsCurrState_[static_cast<int>(GamepadButton::Y)] == KeyState::Pressed)
  {
    std::cout << "Button Y is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::Y)] == KeyState::HeldDown)
  {
    std::cout << "Button Y is held down" << std::endl;
  }

  // Left Trigger
  if (buttonsCurrState_[static_cast<int>(GamepadButton::LeftTrigger)] == KeyState::Pressed)
  {
    std::cout << "Left Trigger is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::LeftTrigger)] == KeyState::HeldDown)
  {
    std::cout << "Left Trigger is held down" << std::endl;
  }

  // Right Trigger
  if (buttonsCurrState_[static_cast<int>(GamepadButton::RightTrigger)] == KeyState::Pressed)
  {
    std::cout << "Right Trigger is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::RightTrigger)] == KeyState::HeldDown)
  {
    std::cout << "Right Trigger is held down" << std::endl;
  }

  // Back button
  if (buttonsCurrState_[static_cast<int>(GamepadButton::Back)] == KeyState::Pressed)
  {
    std::cout << "Back button is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::Back)] == KeyState::HeldDown)
  {
    std::cout << "Back button is held down" << std::endl;
  }

  // Start Button
  if (buttonsCurrState_[static_cast<int>(GamepadButton::Start)] == KeyState::Pressed)
  {
    std::cout << "Start button is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::Start)] == KeyState::HeldDown)
  {
  ...
  // Left Thumb
  if (buttonsCurrState_[static_cast<int>(GamepadButton::LeftThumb)] == KeyState::Pressed)
  {
    std::cout << "Left Thumb is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::LeftThumb)] == KeyState::HeldDown)
  {
    std::cout << "Left Thumb is held down" << std::endl;
  }

  // Right Thumb
  if (buttonsCurrState_[static_cast<int>(GamepadButton::RightThumb)] == KeyState::Pressed)
  {
    std::cout << "Right Thumb is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::RightThumb)] == KeyState::HeldDown)
  {
    std::cout << "Right Thumb is held down" << std::endl;
  }

  // Directional Pad Up
  if (buttonsCurrState_[static_cast<int>(GamepadButton::Up)] == KeyState::Pressed)
  {
    std::cout << "DPad UP is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::Up)] == KeyState::HeldDown)
  {
    std::cout << "DPad UP is held down" << std::endl;
  }

  // Directional Pad Right
  if (buttonsCurrState_[static_cast<int>(GamepadButton::Right)] == KeyState::Pressed)
  {
    std::cout << "DPad RIGHT is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::Right)] == KeyState::HeldDown)
  {
    std::cout << "DPad RIGHT is held down" << std::endl;
  }

  // Directional Pad Down
  if (buttonsCurrState_[static_cast<int>(GamepadButton::Down)] == KeyState::Pressed)
  {
    std::cout << "DPad DOWN is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::Down)] == KeyState::HeldDown)
  {
    std::cout << "DPad DOWN is held down" << std::endl;
  }

  // Directional Pad Left
  if (buttonsCurrState_[static_cast<int>(GamepadButton::Left)] == KeyState::Pressed)
  {
    std::cout << "DPad LEFT is pressed" << std::endl;
  }
  else if (buttonsCurrState_[static_cast<int>(GamepadButton::Left)] == KeyState::HeldDown)
  {
